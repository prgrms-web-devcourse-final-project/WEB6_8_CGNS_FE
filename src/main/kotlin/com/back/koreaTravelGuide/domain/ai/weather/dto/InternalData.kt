...
data class PrecipitationData(
    ...
    var day4: PrecipitationInfo? get() = days[4]
        set(value) {
            days[4] = value
        }
    var day5: PrecipitationInfo? get() = days[5]
        set(value) {
            days[5] = value
        }
    var day6: PrecipitationInfo? get() = days[6]
        set(value) {
            days[6] = value
        }
    var day7: PrecipitationInfo? get() = days[7]
        set(value) {
            days[7] = value
        }
    var day8: PrecipitationInfo? get() = days[8]
        set(value) {
            days[8] = value
        }
    var day9: PrecipitationInfo? get() = days[9]
        set(value) {
            days[9] = value
        }
    var day10: PrecipitationInfo? get() = days[10]
        set(value) {
            days[10] = value
        }
}
